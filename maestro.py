...
try:
	if (len(sys.argv) < 1):
		...
		data1 = os.getenv("ProgramFiles") +"\\"  + r"SQL Maestro Group\Oracle Maestro\OracleMaestro.exe"
		...
		data3 = os.getenv("ProgramFiles") +"\\"  + r"SQL Maestro Group\MS SQL Maestro\MsMaestro.exe"
