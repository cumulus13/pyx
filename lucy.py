...
def main():
	...
	data = ((1,"How are you today ?"),(2,"How Nice this Day ?"), (3,"How do you do ?"),(5,"Nice to meet you again "))
	data_f = random.choice(data)
	print ">> " + data_f[1]
	engine.say(data_f[1])
	engine.runAndWait()
	d001 = raw_input(">> ")
	if d001 == "fine":
		...
		print ">> Do you want to know. The status of computer now."
		engine.runAndWait()
		a0000 = raw_input("\r>> ")
		if a0000 == 'yes':
			cek_memory(+40,'full')
