...
""".format(*data_format)
    ...
    def usage(self):
        ...
        parser.add_option('-p', '--prefix',
                          help='Display prefix', action='store', default='')
        parser.add_option('-d', '--description',
                          help='Description Of Server', action='store', default='')
        parser.add_option('-t', '--directory',
                          help='Working Directory', action='store')
        parser.add_option(
            '-e', '--exe', help='Executable Of Server', action='store')
        parser.add_option(
            '-s', '--paremeter', help='Parameter of service executable', action='store', default='')
        parser.add_option(
