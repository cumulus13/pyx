...
def logs(data):
    if os.path.isfile(os.path.join(os.path.dirname(__file__), 'xmove.log')):
        LOGS_PATH = os.path.join(os.path.dirname(__file__), 'xmove.log')
    elif LOGS_PATH != r'':
        if os.path.isdir(LOGS_PATH):
            if os.path.isfile(os.path.join(LOGS_PATH, 'xmove.log')):
                LOGS_PATH = os.path.join(LOGS_PATH, 'xmove.log')
        elif os.path.isfile(LOGS_PATH):
            LOGS_PATH = LOGS_PATH
    else:
        LOGS_PATH = open(os.path.join(os.path.dirname(__file__), 'xmove.log'), 'wb')
        LOGS_PATH.close()
        LOGS_PATH = os.path.join(os.path.dirname(__file__), 'xmove.log')
    f = open(LOGS_PATH, 'a')
