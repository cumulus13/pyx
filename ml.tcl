...
if {[catch "source combobox.tcl"]} {
	source d:/pyx/combobox.tcl
}

if {[catch "source supertext.tcl"]} {
	source d:/pyx/supertext.tcl
}
...
proc exit_editor {} {
	...
	# first save the configuration file "d:/pyx/ml_cfg.ml"
	set fid [open [file join $editor(initial_dir) "d:/pyx/ml_cfg.ml"] w]
