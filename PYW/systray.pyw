...
class Window(QtGui.QWidget):
    def __init__(self):
        ...
        msg = "HAHA HOHOH HEHE"
        self.createMessageGroupBox(msg)
    ...
    def createIconGroupBox(self):
        ...
        self.iconComboBox.addItem(QtGui.QIcon("d:/pyx/images/Connect.png"),
                self.tr("Connect"))
        self.iconComboBox.addItem(QtGui.QIcon("d:/pyx/images/info.png"),
                self.tr("Info"))
        self.iconComboBox.addItem(QtGui.QIcon("d:/pyx/images/Dashboard.png"),
                self.tr("Clock"))
        self.iconComboBox.addItem(QtGui.QIcon("d:/pyx/images/Customize.png"),
                self.tr("Customize"))
        self.iconComboBox.addItem(QtGui.QIcon("d:/pyx/images/Tip.png"),
                self.tr("Tip"))
        self.iconComboBox.addItem(QtGui.QIcon("d:/pyx/images/Tools.png"),
                self.tr("Customize 2"))
    ...
    def createMessageGroupBox(self, data):
        ...
        self.bodyEdit.setPlainText(self.tr(data))
