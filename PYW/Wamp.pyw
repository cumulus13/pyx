...
#wamp_hg = r"c:\Program Files\TortoiseHg\thg.exe"
wamp_hg = [r"h:\pyx\mercurialserver.bat"]
wamp_hg_opt = " serve --web-conf=d:\\xampp\hg\hgwebdir.conf"
#mcontrol = r"h:\wamp\wamp_shell.bat"
gui= r"h:\wamp\wamp-control.exe"
wamp_dataconf = r"h:\wamp\apache\conf\extra\httpd-wamp.conf"
apache_dataconf = r"H:\wamp\bin\apache\Apache2.2.11\conf\httpd.conf"
vhost_dataconf = r"H:\wamp\bin\apache\Apache2.2.11\conf\extra\httpd-vhosts.conf"
proxy_dataconf = r"H:\wamp\bin\apache\Apache2.2.11\conf\extra\httpd-vhost-proxy.conf"
php_dataconf = r"H:\wamp\bin\php\php5.2.9-2\php.ini"
mysql_dataconf = r"H:\wamp\bin\mysql\mysql5.1.33\my.ini"
