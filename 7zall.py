...
def rarme():
	try:
		...
		for i in range(0,len(data_list)):
			...
			try:
				if data_rar_02[0] != "":
					os.system("7z -t7z a \"" + data_compress + ".7z\" \"" + data_pack[0] + "\"") 
					os.system("7z t \"" + data_compress + ".7z\" ") 
				else:
					pass
			except:
				#print data_rar_02 + ".rar"
				os.system("7z -t7z a \"" + data_rar_02 + ".7z\" \"" + data_pack[0] + "\"") 
				os.system("7z t \"" + data_rar_02 + ".7z\" ") 
		print "############################ TEST ARCHIEVE #############################\n"
		os.system("7z t *.7z")
		#for i in range(0,len(data_list)):
		#	data_pack = str(data_list[i]).split("\n")
		...
		#			os.system("7z t \"" + data_rar_02[0] + ".7z\" ") 
		#		else:
		#			pass
		#	except:
		#		print data_rar_02 + ".rar"
...
def test():
	...
	data_list = os.popen("dir /b ").readlines()
	#os.system("7z -t7z a \"" + data_rar_02 + ".7z\" \"" + sys.argv[1] + "\"") 
	#os.system("7z t \"" + data_rar_02 + ".7z\" ") 
	for i in range(0,len(data_list)):
		data_pack = str(data_list[i]).split("\n")
		data_rar_02 = str(data_pack[0]).split(".")
