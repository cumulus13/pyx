...
if (os.path.isfile(filename) == True):
    ...
    if (lendata > 1):
        ...
        for i in range(0, lendata):
            ...
            try:
                ...
                os.system("""sysloggen -q -t:192.168.128.1 -p:523 -f:0 -s:6 -m:"FOUND : amt.log, But MySQL Error !, System Exit""")
                #sys.exit()
    ...
    os.system("""sysloggen -q -t:192.168.128.1 -p:523 -f:0 -s:6 -m:"File amt.log Not Found ! """)
    sys.exit()
...
os.system("""sysloggen -q -t:192.168.128.1 -p:523 -f:0 -s:6 -m:"Found File amt.log Successfull Generate ! """)
