...
data_proxomitron = os.getenv("ProgramFiles") +"\\"  + r"Proxomitron Naoko-4\Proxomitron.exe"
data_httpproxy = os.getenv("ProgramFiles") +"\\"  + r"DPA_PROXY\DPAHTTPProxy.exe"
data_proxyway = os.getenv("ProgramFiles") +"\\"  + r"ProxyWay\proxyway.exe"
data_free_proxy = os.getenv("ProgramFiles") +"\\"  + r"Hand-Crafted Software\FreeProxy\FreeProxyClient.exe"
data_analogx_proxy = os.getenv("ProgramFiles") +"\\"  + r"AnalogX\Proxy\proxy.exe"
data_paros = os.getenv("ProgramFiles") +"\\"  + r"Paros\startserver.bat"
data_proxy_elhttp = os.getenv("ProgramFiles") +"\\"  + r"Etlin HTTP Proxy\HTTPProxy.exe"
