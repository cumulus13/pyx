...
challengePassword      = %s
    ...
    def keymaker(self, quiet=None):
        ...
        # print "KEY  =", os.path.join(path, self.host) + ".key"
...
ServerName %s
ServerAlias www.%s
ErrorLog "logs/vhost/%s-error.log"
CustomLog "logs/vhost/%s-access.log" common
%s
%s
...
SSLCipherSuite HIGH:MEDIUM:!aNULL:+SHA1:+MD5:+HIGH:+MEDIUM
    ...
    ServerName %s
    ServerAlias www.%s
    ErrorLog "logs/vhost/%s.https-error.log"
    CustomLog "logs/vhost/%s.https-access.log" common
</VirtualHost>
...
<VirtualHost *:443>
    ...
    def usage(self):
        ...
        parser.add_argument('-q', '--quiet', help="by pass confirmation other options, by answer 'yes'", action="store", default = 'yes')
        ...
        args_vhost.add_argument('-q', '--quiet', help="by pass confirmation other options, by answer 'yes'", action="store", default = 'yes')
        ...
        args_proxy.add_argument('-q', '--quiet', help="by pass confirmation other options, by answer 'yes'", action="store", default = 'yes')
