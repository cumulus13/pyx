...
class chm2web:
    ...
    def version(self):
        try:
            import __version__
            import __test__
            return "version: {0}({1})".format(__version__, __test__)
        except:
            import __init__
            return "version: {0}({1})".format(__init__.__version__, __init__.__test__)
    ...
    def command(self, print_help=None):
        ...
        parser.add_option("-p", "--project", help="Project File (*.chm2web), default='project.chm2web'", action="store")
        ...
        parser.add_option('-V', "--version", help = "Show version number", action = 'store_true')
