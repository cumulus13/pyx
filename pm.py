...
class pm(object):
    def __index__(self, MASTER_PATH = None):
        super(pm, self)
            ...
            if os.path.isfile(i):
                ...
                if not self.translate(i):
                    ...
                    if verbosity:
                        if overwrite:
                            if backup:
                                print make_colors('COPY', 'red', 'yellow') + " " + make_colors("[OVERWRITE-BACKUP]", 'white', 'red') + ": " + make_colors(str(i), 'yellow') + make_colors(" --> ", 'green') + make_colors(DEST_NAME, 'magenta')
                            else:
                                print make_colors('COPY', 'red', 'yellow') + " " + make_colors("[OVERWRITE]", 'white', 'red') + ": " + make_colors(str(i), 'yellow') + make_colors(" --> ", 'green') + make_colors(DEST_NAME, 'magenta')
                        else:
                            if backup:
                                print make_colors('COPY', 'red', 'yellow') + " " + make_colors("[BACKUP]", 'white', 'red') + ": " + make_colors(str(i), 'yellow') + make_colors(" --> ", 'green') + make_colors(DEST_NAME, 'magenta')
                            else:
                                print make_colors('COPY', 'red', 'yellow') + ": " + make_colors(str(i), 'yellow') + make_colors(" --> ", 'green') + make_colors(DEST_NAME, 'magenta')                    
