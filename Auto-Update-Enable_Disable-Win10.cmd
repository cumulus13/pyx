...
:KEYON
echo ============================================================
echo www.kuyhaa-android19.com
echo Otomatis Update saat ini sedang dinonaktifkan/disabled.
echo apakah kamu ingin re-enable otomatis update windows?ketik: Y atau N
echo ============================================================
echo.
choice /c yn /n
...
echo apakah kamu ingin disable/menonaktifkan otomatis update windows?ketik: Y atau N
echo ============================================================
echo.
choice /c yn /n
If %ERRORLEVEL% NEQ 1 GOTO :QUIT
