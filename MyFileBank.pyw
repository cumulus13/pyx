...
class MainApp(QtGui.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.resize(900, 650)
        self.setWindowIcon(QtGui.QIcon('C:\pyx\Bug.png'))
...
##################################################################################################################################################################
    ...
    def windowfilelist(self):
        data001 = 'dir /d C:\CD_DVD_LIST\P*list*'
        data002 = 'dir /b C:\CD_DVD_LIST\P*list*'
        self.filelist(data001, data002)


    def windowfiletree(self):
        data001 = 'dir /d C:\CD_DVD_LIST\P*tree*'
        data002 = 'dir /b C:\CD_DVD_LIST\P*tree*'
        self.filetree(data001, data002)


    def linuxfilelist(self):
        data01 = 'dir /d C:\CD_DVD_LIST\L0*list*'
        data02 = 'dir /b C:\CD_DVD_LIST\L0*list*'
        self.combofile.clear()
        self.resultlabelout.setText("")
        if self.RB_linfile.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\L0*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\L0*list*').readlines( )
    ...
    def linuxfiletree(self):
        ...
        if self.RB_linfile.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\L0*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\L0*tree*').readlines( )
    ...
    def windowMfilelist(self):
        ...
        if self.RB_winmaster.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\W0*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\W0*list*').readlines( )
    ...
    def windowMfiletree(self):
        ...
        if self.RB_winmaster.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\W0*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\W0*tree*').readlines( )
    ...
    def linuxmfilelist(self):
        ...
        if self.RB_linmaster.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\LM*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\LM*list*').readlines( )
    ...
    def linuxmfiletree(self):
        ...
        if self.RB_linmaster.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\LM*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\LM*tree*').readlines( )
    ...
    def musicfilelist(self):
        ...
        if self.RB_music.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\M*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\M*list*').readlines( )
    ...
    def musicfiletree(self):
        ...
        if self.RB_music.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\M*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\M*tree*').readlines( )
    ...
    def driverstudiofilelist(self):
        ...
        if self.RB_driverstudio.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\D*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\D*list*').readlines( )
    ...
    def driverstudiofiletree(self):
        ...
        if self.RB_driverstudio.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\D*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\D*tree*').readlines( )
    ...
    def ebookfilelist(self):
        ...
        if self.RB_ebookfile.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\E*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\E*list*').readlines( )
    ...
    def ebookfiletree(self):
        ...
        if self.RB_ebookfile.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\E*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\E*tree*').readlines( )
    ...
    def netsoftlist(self):
        ...
        if self.RB_netsoft.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\N*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\N*list*').readlines( )
    ...
    def netsofttree(self):
        ...
        if self.RB_netsoft.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\N*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\N*tree*').readlines( )
    ...
    def hddbcklist(self):
        ...
        if self.RB_hddbck.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\HD*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\HD*list*').readlines( )
    ...
    def hddbcktree(self):
        ...
        if self.RB_hddbck.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\HD*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\HD*tree*').readlines( )
    ...
    def hackersoftlist(self):
        ...
        if self.RB_hackersoft.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\HCK*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\HCK*list*').readlines( )
    ...
    def hackersofttree(self):
        ...
        if self.RB_hackersoft.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\HCK*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\HCK*tree*').readlines( )
    ...
    def gamesoftlist(self):
        ...
        if self.RB_gamesoft.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\G*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\G*list*').readlines( )
    ...
    def gamesofttree(self):
        ...
        if self.RB_gamesoft.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\G*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\G*tree*').readlines( )
    ...
    def bootsoftlist(self):
        ...
        if self.RB_bootsoft.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\B0*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\B0*list*').readlines( )
    ...
    def bootsofttree(self):
        ...
        if self.RB_bootsoft.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\B0*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\B0*tree*').readlines( )
    ...
    def databcklist(self):
        ...
        if self.RB_databck.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\BCK*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\BCK*list*').readlines( )
    ...
    def databcktree(self):
        ...
        if self.RB_databck.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\BCK*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\BCK*tree*').readlines( )
    ...
    def datatutoriallist(self):
        ...
        if self.RB_tutorial.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\T0*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\T0*list*').readlines( )
    ...
    def datatutorialtree(self):
        ...
        if self.RB_tutorial.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\T0*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\T0*tree*').readlines( )
    ...
    def datafilmlist(self):
        ...
        if self.RB_film.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\F*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\F*list*').readlines( )
    ...
    def datafilmtree(self):
        ...
        if self.RB_film.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\F*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\F*tree*').readlines( )
    ...
    def datawinmasteroldlist(self):
        ...
        if self.RB_winmasterold.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\WD*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\WD*list*').readlines( )
    ...
    def datawinmasteroldtree(self):
        ...
        if self.RB_winmasterold.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\WD*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\WD*tree*').readlines( )
    ...
    def datatoralist(self):
        ...
        if self.RB_tora.isChecked() and self.combofilelist.isChecked():
            datanumlist =  os.popen('dir /d C:\CD_DVD_LIST\TR*list*').readlines( )
            dataxnumlist =  datanumlist[-2].split(" File(s)")
            dataznumlist =  dataxnumlist[0].split(" ")
            x = int(dataznumlist[-1])
            print x
            #print dataz[-1]
            datalist = os.popen('dir /b C:\CD_DVD_LIST\TR*list*').readlines( )
    ...
    def datatoratree(self):
        ...
        if self.RB_tora.isChecked() and self.combofiletree.isChecked():
            datanumtree =  os.popen('dir /d C:\CD_DVD_LIST\TR*tree*').readlines( )
            dataxnumtree =  datanumtree[-2].split(" File(s)")
            dataznumtree =  dataxnumtree[0].split(" ")
            x = int(dataznumtree[-1])
            print x
            #print dataz[-1]
            datatree = os.popen('dir /b C:\CD_DVD_LIST\TR*tree*').readlines( )
...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    def totalsize(self):
        try:
            filedata = 'C:\CD_DVD_LIST\\' + self.combofile.currentText()
            dataprint = "Hallo"
            #self.resultTotalout = QtGui.QLabel(self)
    ...
    def searchallfile(self):
        ...
        if (self.RB_winfile.isChecked()):
            ...
            dataver02 = open("C:\CD_DVD_LIST\\dataver.dat", "r").read()

            if (self.combofilelist.isChecked()):

                self.combofiletree.setChecked(False)

                dataid = os.popen("dir /b C:\CD_DVD_LIST\\" + dataver02 + "*list*").readlines()
                print "dataid = ", dataid, "\n"
                print "Len dataid = ", len(dataid)

                if (os.path.isfile('C:\CD_DVD_LIST\\zresult.dat') == True):
                    os.remove('C:\CD_DVD_LIST\\zresult.dat')
                    dataresult = open("C:\CD_DVD_LIST\\zresult.dat", "w")
                    dataresult.close()
                    ...
                    for i in range(0, len(dataid)):
                        ...
                        datacheck = open("C:\CD_DVD_LIST\\" + datacek[0], "r").readlines()
                        #print datacheck
                        for j in range(0, len(datacheck)):
                            ...
                            if str(datafile) in datacheck[j]:
                                ...
                                dataresult04 = open("C:\CD_DVD_LIST\\zresult.dat", "a").write(datarecord)
                                dataresult05 = open("C:\CD_DVD_LIST\\zresult.dat", "r").read()
                                print dataresult05
                ...
                dataid = os.popen("dir /b C:\CD_DVD_LIST\\" + dataver02 + "*tree*").readlines()
                print dataid, "\n"
                print "Len dataid = ", len(dataid)
        ...
        try:
            if self.RB_currentFile.isChecked():
                ...
                if (len(datafile) < 1):
                    ...
                    data = open("C:\CD_DVD_LIST\\" + datafile).readlines()
                    print "data = ", data, "\n"
                    lendata = len(data)
                    print "lendata = ", lendata, "\n"
                    ...
                    if (os.path.isfile('C:\CD_DVD_LIST\\zresult.dat') == True):
                        os.remove('C:\CD_DVD_LIST\\zresult.dat')
                        dataresult01 = open("C:\CD_DVD_LIST\\zresult.dat", "w")
                        dataresult01.close()
                        for x in range(0, lendata):
                            #print "x = ", x
                            ...
                            if str(i) in data[x]:
                                #print "\n"
                                datax01 =  "\n Line : " + str(x) + ". " + data[x]
                                dataresult02 = open("C:\CD_DVD_LIST\\zresult.dat", "a").write(datax01)
                                dataresult03 = open("C:\CD_DVD_LIST\\zresult.dat", "r").read()
    ...
    def versearch(self):
        if(self.RB_winfile.isChecked()):
            datast = "P"
            dataver01 = open("C:\CD_DVD_LIST\\dataver.dat", "w").write(str(datast))
